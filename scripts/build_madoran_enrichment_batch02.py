...
ITEMS = {
    ...
    85: item("dak chibani kan rafed 9ar3a ta3 gaz. refdha w galou yskon lhi h. gal hada chibani yerfed 9ar3a ta3 gaz la5or ki ykoun wla l douarhom.", "The old man was carrying a gas cylinder. He lifted it and said that the man lived over there. He said, 'This old man carries another gas cylinder when he goes to their village.'", "그 노인은 가스통을 들고 있었어. 그는 그 사람이 저쪽에 산다고 말했어. 그리고 '이 노인은 자기들 마을에 갈 때 가스통을 하나 더 들고 다닌다'고 했어.", "B2", 60, "humor", "ambiguous_reference", "joke", "opinion", "colloquial", "high", "source_ambiguity"),
    ...
    97: item("wahed sayed ymout 3la martou 9atlha rou7 chri li babouch. ki houad lmerchi ychri lha babouch, ki ja tal3 chaf tabla ta3 domino w howa ymout 3la domino.", "A man who loved his wife went to the market because she asked him to buy snails. On the way, he saw a domino table and loved dominoes even more.", "아내를 사랑한 한 남자가 아내의 부탁으로 달팽이를 사러 시장에 갔어. 그런데 가는 길에 도미노 판을 보자 그는 도미노를 더 좋아했어.", "B1", 48, "family_relationships", "dominoes", "joke", "narration", "colloquial", "medium"),
    ...
    99: item("w howa ymout 3la domino ja fat 3la 7ouma l9a jma3a yl3abou domino double six. toul ma dar ch sa3a, dar 4 swaye3.", "On his way to buy the snails, he passed through a neighborhood where people were playing double-six dominoes. He intended to play briefly but ended up playing for four hours.", "그는 달팽이를 사러 가는 길에 사람들이 더블 식스 도미노를 하는 동네에 들렀어. 잠깐만 하려 했지만 결국 네 시간을 하고 말았어.", "B1", 45, "family_relationships", "dominoes", "joke", "narration", "colloquial", "medium"),
    100: item("ki ydir ki ydir cha y9oul lmartou, d rok b tet. ki y9oulha cha dar, 7ot baboucha 3and bab, 7abba men 7abba w 7abba t7at 7d bab. 9atlha hada win tji, wallah l jibt homa men lmerchi ldar.", "When he realized he was late, he told his wife, 'I was delayed.' He placed the snails one by one at the door. She asked, 'Where are these coming from?' He said, 'I swear, I brought them from the market to the house.'", "그가 늦었다는 걸 깨닫고 아내에게 '늦어졌어'라고 말했어. 그는 달팽이들을 하나씩 문 앞에 놓았고, 아내가 '이건 어디서 오는 거야?'라고 묻자 '맹세코 시장에서 집으로 가져온 거야'라고 했어.", "B2", 60, "family_relationships", "dominoes", "joke", "narration", "colloquial", "high", "source_ambiguity"),
    ...
    117: item("@@SOURCE_CORRUPTION_1@@ li bagha ga3 khlaha ga3.", "Whoever wanted everything, let her have everything.", "모든 것을 원한 사람에게 모든 것을 갖게 하라는 뜻이야.", "B1", 48, "culture_tradition", "proverb", "proverb", "opinion", "colloquial", "high", "source_corruption"),
