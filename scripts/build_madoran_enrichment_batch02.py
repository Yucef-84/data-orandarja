...
ITEMS = {
    ...
    66: item("lbaraj lwewel tahou f ljandarm bdaou yba3rou ba3 ba3. khalawhom yfoutou.", "At the first checkpoint they ran into the gendarmes and started bleating, baa baa; the gendarmes let them pass.", "첫 번째 검문소에서 헌병들을 만나자 그들은 음메 음메 울기 시작했고, 헌병들은 그들을 지나가게 했어.", "A2", 28, "travel", "checkpoint_evasion", "joke", "narration", "colloquial", "medium"),
    67: item("lbaraj tani ta3 militar bdaou yba3rou ba3 ba3. khalawhom yfoutou.", "At the second military checkpoint, they started bleating, 'baa baa,' and the guards let them pass.", "두 번째 군 검문소에서 그들은 '음메 음메' 울기 시작했고, 검문소 사람들이 지나가게 했어.", "A2", 28, "travel", "checkpoint_evasion", "joke", "narration", "colloquial", "medium"),
    68: item("lbaraj talt ta3 l irhab sktou ga3. ghi l3ma ma chafch, bqa yba3er ba3 ba3 hatta darbou sahbou w galou skot rana wslna lbatwar.", "At the third checkpoint, a terrorism checkpoint, they all fell silent. Only the blind man did not notice; he kept bleating until his friend hit him and said, 'Be quiet, we have reached the slaughterhouse.'", "세 번째 검문소인 테러 검문소에서는 모두 조용해졌어. 그런데 눈먼 사람만 알아차리지 못하고 계속 음메 울었고, 친구가 그를 치며 말했어. '조용히 해, 우리 도살장에 도착했어.'", "B2", 58, "crime_safety", "checkpoint_evasion", "joke", "narration", "colloquial", "high", "context_heavy"),
    69: item("galek merra houari doufane kan 3andou hafla f ma3askar. aya lma3askriyat 93dou yqara3oulou f lbor.", "They say that once Houari Doufane had a concert in Mascara, and the women of Mascara sat waiting for him in the hall.", "한번은 우아리 두판이 마스카라에서 공연을 했는데, 마스카라의 여성들이 홀에서 계속 그를 기다리고 있었대.", "B1", 42, "entertainment_music", "concert", "joke", "information", "colloquial", "medium"),
    ...
    73: item("salam w 3likoum kirak labes. ftert ghaya lyoum? wah ghaya. ch klit? klit bourak b batata. aya bsa7tek weldi.", "Hello, how are you? Did you eat well today? Yes, very well. What did you eat? I ate potato bourek. Good health to you, my son.", "안녕하세요, 잘 지내? 오늘 잘 먹었어? 응, 아주 잘 먹었어. 뭘 먹었어? 감자 부레크를 먹었어. 맛있게 먹어, 얘야.", "A1", 18, "food", "meal", "conversation", "greeting", "colloquial", "low"),
    74: item("salam w 3likoum ya khouya. da7akni galek wahed chibani s9sawh kirak m3a ramdan galhom koun machi dik joghma ta3 lwodou koun rani met.", "An old man was asked how he was doing during Ramadan. He said, 'If it were not for that sip of water used for ablution, I would be dead.'", "한 노인에게 라마단 동안 어떻게 지내냐고 물었더니, 그가 말했어. '그 세정용 물 한 모금이 아니었으면 나는 죽었을 거야.'", "B1", 42, "religion", "ramadan", "joke", "information", "colloquial", "medium", "idiom_culture"),
    75: item("galek merra wahed 3roubi f triq doublino. kan f lagona 22 nhar li khrej. galek dar aksidon, khrej wahed galhom audi loto m3lich, moul l3baya bayda chkoun houwa.", "They say a country man was once on the road to Doublino. After being out for twenty-two days, he had an accident. Someone came out and asked, 'Is the car all right? Who is the man in the white cloak?'", "어느 시골 사람이 두블리노로 가는 길에 있었대. 나간 지 22일째 사고가 났고, 한 사람이 나와 물었어. '차는 괜찮아요? 흰 망토를 입은 사람은 누구예요?'", "B2", 60, "travel", "road_accident", "joke", "question", "colloquial", "high", "context_heavy|source_ambiguity"),
    ...
    80: item("aya 3awed ghodwa ja b perruque bach ma y3a9elch 3lih w galou ch7al hadhi lmachina l avi. galou ma nbi3ch lma3askriyin.", "The next day he came back wearing a wig so the shopkeeper would not recognize him, and asked the price of the washing machine. The shopkeeper still said, 'I do not sell to people from Mascara.'", "다음 날 그는 가게 주인이 알아보지 못하게 가발을 쓰고 다시 와서 세탁기 가격을 물었어. 가게 주인은 여전히 '나는 마스카라 사람에게는 팔지 않아요'라고 했어.", "A2", 30, "shopping", "appliance_shopping", "joke", "information", "colloquial", "medium"),
    ...
    83: item("wahed na9ra sme3 belli kayen wahed na9ra w khadakhor yskon f douar. gal wallah ghir nrou7ou 3andou nchouf had na9ra ghadi nkemel 3lih.", "A 'na9ra' heard that another 'na9ra' and someone else lived in a village. He said, 'By God, let's go to him and see this na9ra; I will finish him.'", "한 'na9ra'가 어떤 마을에 또 다른 'na9ra'와 다른 사람이 산다는 말을 듣고 말했어. '맹세코 그 사람에게 가서 이 na9ra를 보자. 내가 끝장내겠어.'", "B2", 62, "humor", "ambiguous_reference", "joke", "narration", "colloquial", "high", "source_ambiguity"),
    84: item("ki ra7 3andou y temcha y temcha howa yskon f douar f jbel l9a wahed chibani galou 7am bouk hada na9ra win yskon.", "When he went to look for him in the mountain village, he found an old man and asked, 'Uncle, where does this na9ra live?'", "그를 찾으러 산속 마을에 가서 노인을 만나자 '아저씨, 이 na9ra는 어디에 살아요?'라고 물었어.", "B2", 55, "humor", "ambiguous_reference", "joke", "question", "colloquial", "high", "source_ambiguity"),
    85: item("dak chibani kan rafed 9ar3a ta3 gaz. refdha w galou yskon lhi h. gal hada chibani yerfed 9ar3a ta3 gaz la5or ki ykoun wla l douarhom.", "The old man was carrying a gas cylinder. He lifted it and said, 'He lives over there.' The reference to the other one and the clause about their village are unclear.", "그 노인은 가스통을 들고 있었어. 그는 그것을 들어 올리며 '그는 저쪽에 살아'라고 말했어. 다른 대상에 관한 부분과 그들의 마을에 관한 절은 분명하지 않아.", "B2", 60, "humor", "ambiguous_reference", "joke", "opinion", "colloquial", "high", "source_ambiguity"),
    ...
    88: item("wahed fransi s9sa arjighia galou 3lach ntouma ki tehderou tdkhlou hadr etna m3akom. galou ana jami 9oltha.", "A Frenchman asked an Algerian, 'Why do you bring our speech into your language when you talk?' The Algerian answered, 'I never said that—jamais.'", "한 프랑스인이 알제리인에게 '당신들은 말할 때 왜 우리 말을 자기들 말에 섞나요?'라고 물었어. 알제리인은 '나는 그런 말을 한 적 없어—jamais(절대)'라고 대답했어.", "B1", 42, "culture_tradition", "language_mixing", "joke", "answer", "colloquial", "high", "code_switching"),
    89: item("wahed mghandef 9abed taraf glasou dayrou f chams. ja 3andou sahbou galou cha rak dir. galou baghi n9ed f wein rahi.", "A foolish man was holding a piece of glass in the sun. His friend asked what he was doing, and he said, 'I want to catch it wherever it is.'", "어리석은 남자가 유리 조각을 햇볕에 들고 있었어. 친구가 뭘 하냐고 묻자 그는 '그것이 어디에 있든 붙잡고 싶어'라고 말했어.", "B1", 42, "humor", "foolishness", "joke", "answer", "colloquial", "high", "source_ambiguity"),
    90: item("wahed bgha yent a7er 9a3ed y tla3 fou9 bank w y9is rou7ou. chafou wahed rajel galou cha rak dir. galou baghi n9is rou7i. galou ila baghi tenta7er rou7 tla3 fou9 batimat w 9is rou7ek. galou 3lach rak baghini nmout.", "A man wanted to commit suicide. He climbed onto a bench and said he wanted to measure himself. Another man told him to climb onto buildings and measure himself, and he asked, 'Why do you want me to die?'", "어떤 남자가 자살하려고 했어. 그는 벤치에 올라가 자신을 재고 싶다고 말했지. 다른 사람이 건물 위로 올라가 자신을 재라고 하자, 그는 '왜 나를 죽게 하려는 거예요?'라고 물었어.", "B2", 55, "crime_safety", "wordplay", "joke", "question", "colloquial", "high", "context_heavy"),
    91: item("merra wahed dkhel 3and kawafir. 9a3ed y7asen ki 7asenlou w kemel galou khalsni. 9a3ed yferfer ma l9ach drahem galou ma 3andich. galou emli 9a3ed hna ki tetghafel khrej.", "A man went to a barber and sat while the barber cut his hair. When it was finished, the barber asked for payment, but the man had no money. The barber told him, 'Stay here.' When the barber was distracted, the man left.", "어떤 남자가 이발소에 가서 머리를 잘랐어. 이발이 끝나 돈을 내라고 하자 돈이 없었지. 이발사는 '여기 있어'라고 했고, 이발사가 한눈판 사이에 남자는 나가 버렸어.", "B1", 45, "work", "barber_payment", "joke", "narration", "colloquial", "high"),
    ...
    95: item("kifach mart ek 3andha? 9alou kifha kifkom mow atina jaz ayr iya 3andha 7a9 tedi. chouf asidi, yrou7 wahed cha3b wla mowaten 3adi. ma y3tiwh, wallah ma yk7el 3liha, w weld 3abbas rayes ta3 7izb @@SOURCE_CORRUPTION_1@@ galhom 7na rana 3aychin khir men swid, hada machi m5alel f 3a9lou, hada m hbol.", "They asked how his wife could have them. He replied, 'She is an Algerian citizen like you and has the right to receive.' 'Look, sir: an ordinary citizen, poor or not—look at what they give him; by God, he does not even see it.' Ould Abbas, a party leader, told them, 'We are living better than Sweden.' This is not merely someone confused in his mind; this is a madman.", "아내가 어떻게 그런 것을 가질 수 있느냐고 묻자 그는 '아내도 당신들과 같은 알제리 시민이고 받을 권리가 있다'고 대답했어. '보세요, 평범한 시민이든 가난한 사람이든 사람들이 받는 것을 보세요. 맹세코 그는 그것을 보지도 못해요.' 정당 지도자인 울드 압바스는 '우리는 스웨덴보다 더 잘 살고 있다'고 말했어. 이건 단순히 정신이 혼란스러운 사람이 아니라 미친 사람이야.", "C2", 95, "politics_public_affairs", "political_satire", "joke", "opinion", "mixed", "high", "context_heavy|source_corruption"),
    96: item("lyoum f lmosalsel, ki kan Merzak y3an9 7bib tou, jedati 9atli sa7 l9a khtou. w ah sa7 l9aha mskin, 9atli w ana kent 7asba Zoli5a hiya li khtou.", "Today, in the television series, when Merzak hugged his beloved, my grandmother told me, 'So he has found his sister.' Yes, poor thing, he finally found her. She told me, 'I had thought Zuleikha was his sister.'", "오늘 텔레비전 드라마에서 메르자크가 연인을 안자 할머니가 나에게 말했어. '그래, 자기 여동생을 찾았네.' 맞아, 불쌍하게도 마침내 그녀를 찾은 거야. 할머니는 '나는 줄레이카가 그의 여동생인 줄 알았어'라고 말했어.", "B2", 65, "entertainment_music", "television_series", "joke", "opinion", "colloquial", "high", "context_heavy|source_ambiguity"),
    97: item("wahed sayed ymout men martou 9atletlou rou7 chri li babouch. ki houad lmerchi ychri lha babouch, ki ja tal3 chaf tabla ta3 domino w howa ymout 3la domino.", "A man who was dying because of his wife; she told him, 'Go buy me snails.' When he went to the market to buy them for her, he saw a domino table and loved dominoes even more.", "아내 때문에 죽을 지경인 남자에게 아내가 '가서 나한테 달팽이를 사 와'라고 했어. 그가 아내에게 줄 달팽이를 사러 시장에 갔을 때 도미노 판을 보자 도미노를 더 좋아하게 됐어.", "B1", 48, "family_relationships", "dominoes", "joke", "narration", "colloquial", "medium"),
    98: item("w martou 9atlha khof ma twalch 3liya, 3andek khams d9aye9 t chri li babouch w tji.", "His wife told him not to take long: he had five minutes to buy the snails and come back.", "아내는 오래 걸리지 말라고 했어. 달팽이를 사서 5분 안에 돌아오라는 뜻이었지.", "A2", 28, "family_relationships", "dominoes", "conversation", "command", "colloquial", "low"),
    99: item("w howa ymout 3la domino ja fat 3la 7ouma l9a jma3a yl3abou domino double six. toul ma dar ch sa3a, dar 4 swaye3.", "He loved dominoes; he passed through a neighborhood and found a group playing double-six dominoes. He intended to play briefly but ended up playing for four hours.", "그는 도미노를 아주 좋아했어. 동네를 지나가다가 사람들이 더블 식스 도미노를 하는 것을 보았어. 잠깐만 하려 했지만 결국 네 시간을 하고 말았어.", "B1", 45, "family_relationships", "dominoes", "joke", "narration", "colloquial", "medium"),
    100: item("ki ydir ki ydir cha y9oul lmartou, d rok b tet. ki y9oulha cha dar, 7ot baboucha 3and bab, 7abba men 7abba w 7abba t7at 7d bab. 9atlha hada win tji, wallah l jibt homa a pied men lmerchi ldar.", "When he realized he was late, he told his wife, 'I was delayed.' He placed the snails one by one at the door. She asked, 'You're only coming back now?' He said, 'I swear, I brought them on foot from the market to the house.'", "그가 늦었다는 걸 깨닫고 아내에게 '늦어졌어'라고 말했어. 그는 달팽이들을 하나씩 문 앞에 놓았고, 아내가 '이제야 오는 거야?'라고 묻자 '맹세코 시장에서 집까지 걸어서 가져왔어'라고 했어.", "B2", 60, "family_relationships", "dominoes", "joke", "narration", "colloquial", "high", "source_ambiguity"),
    ...
    102: item("galek wahed nhar wahed ma3askri tla3 l Ain Temouchent, mcha l7anout ta3 mawad gh ida2iya w s9sah ch7al ydir l3lak.", "They say a man from Mascara went to Ain Temouchent, entered a grocery shop, and asked how much chewing gum cost.", "어느 날 마스카라 사람이 아인 테무셴트에 가서 식료품점에 들어가 껌이 얼마인지 물었대.", "A2", 30, "shopping", "chewing_gum", "joke", "question", "colloquial", "medium"),
    ...
    105: item("galou temouchenti hada machi 3lak, hada jumbo.", "The man from Ain Temouchent replied, 'This is not gum; it is Jumbo.'", "아인 테무셴트 사람이 대답했어. '이건 껌이 아니라 점보예요.'", "A2", 25, "shopping", "chewing_gum", "joke", "answer", "colloquial", "medium"),
    ...
    108: item("n3ardou ga3 lghachi, kima l7bab w jiran, w ndi rou nef s hiya l9as3a.", "We invite all the people, including relatives and neighbors, and hold a newborn celebration with the large communal dish.", "우리는 친척과 이웃을 비롯한 모든 사람을 초대하고 큰 공동 접시를 차려 신생아 잔치를 열어.", "B1", 40, "family_relationships", "newborn_baby", "narrative", "information", "colloquial", "medium", "idiom_culture"),
    109: item("nwej dou lhom berkoukes w limonad w ma ta9na 7lowa w gato w 9ahwa w tay, w n7ottouhom lnas m3ar din w nfoutouha b lhedra w d7ak.", "We prepare berkoukes, lemonade, the sweet item written 'ma ta9na 7lowa', cake, coffee, and tea for the guests, then spend the afternoon talking and laughing.", "우리는 손님들을 위해 베르쿠스, 레모네이드, 'ma ta9na 7lowa'라는 단 음식, 케이크, 커피와 차를 준비하고 오후 내내 이야기하며 웃어.", "B1", 45, "family_relationships", "newborn_baby", "narrative", "information", "colloquial", "medium", "source_ambiguity"),
    110: item("kayn li ymed lnafs a drahem w kayn li ymed kadouat, kol wa7ed yjib lnejmet 3lih.", "Some people give money to the postpartum woman, and others bring gifts; each person brings what they can.", "어떤 사람은 산후 여인에게 돈을 주고, 어떤 사람은 선물을 가져와. 사람마다 할 수 있는 만큼 가져오는 거야.", "B1", 42, "family_relationships", "newborn_baby", "narrative", "information", "colloquial", "medium"),
    ...
    114: item("khedem ya ba9i lcha9i, w koul ya mstarra7.", "Work, you who toil, and eat, you who rest.", "일해라, 수고하는 사람아. 그리고 쉬는 사람은 먹어라.", "A2", 30, "work", "proverb", "proverb", "command", "colloquial", "medium"),
    ...
    117: item("@@SOURCE_CORRUPTION_1@@ li bagha ga3 khlaha ga3.", "The source says, 'Whoever wanted everything, ... everything,' but the meaning of 'khlaha' is unclear.", "원문은 '모든 것을 원한 사람은 ... 모든 것을'이라고 말하지만, 'khlaha'의 의미는 분명하지 않아.", "B1", 48, "culture_tradition", "proverb", "proverb", "opinion", "colloquial", "high", "source_ambiguity|source_corruption"),
    ...
    121: item("3zizti jazayriya wajda bach nsla7 otorout men gharbha Maghnia l char9ha Tarf, bberousadoun ida bayentili belli had aham chart lzwaj.", "My dear Algerian woman, I am ready to repair the motorway from Maghnia in the west to El Tarf in the east, 'bberousadoun.' If you show me that this is the most important condition for marriage, ...", "나의 알제리 여인이여, 서쪽 마그니아에서 동쪽 엘타르프까지 고속도로를 고칠 준비가 되어 있어, 'bberousadoun.' 이것이 결혼의 가장 중요한 조건이라는 걸 증명한다면 말이야.", "B2", 58, "travel", "marriage_conditions", "conversation", "opinion", "colloquial", "high", "context_heavy|source_ambiguity"),
    122: item("rdat 3lih 9atlou 3zizi jazayri, ana wajda bach n3awed morak b babi f mechwar, ida bentli belli chab jazayri ma yhemmouch zine chira w ychouf ghir f3ayel.", "She replied, 'My dear Algerian, I am ready to walk behind you on a journey if you prove that an Algerian young man does not care about a woman's beauty and looks only at her actions.'", "그녀가 대답했어. '나의 알제리 사람이여, 알제리 젊은 남자는 여자의 외모를 신경 쓰지 않고 행동만 본다는 걸 증명한다면 당신을 따라 걸을 준비가 되어 있어.'", "B2", 62, "family_relationships", "marriage_conditions", "conversation", "opinion", "colloquial", "high", "context_heavy"),
    123: item("okht Sana, kiraki w kirahom nas Wahran.", "Sister Sana, how are you, and how are the people of Oran?", "사나 자매님, 잘 지내요? 오란 사람들은 어떻게 지내요?", "A1", 18, "daily_life", "greeting", "conversation", "greeting", "colloquial", "low"),
    124: item("rani ghaya ghaya w nhadilkom hadhi lghnya.", "I am fine, fine, and I dedicate this song to you.", "나는 잘 지내, 정말 잘 지내. 이 노래를 너희에게 바칠게.", "A2", 25, "entertainment_music", "song_dedication", "conversation", "information", "colloquial", "low"),
    125: item("@@SOURCE_CORRUPTION_1@@ @@SOURCE_CORRUPTION_2@@ @@SOURCE_CORRUPTION_3@@ dourou ha chbiba dourou @@SOURCE_CORRUPTION_4@@ @@SOURCE_CORRUPTION_5@@ @@SOURCE_CORRUPTION_6@@ @@SOURCE_CORRUPTION_7@@.", "Turn around, young people, turn around; seven corruption markers interrupt the source line and its remaining content cannot be read reliably.", "젊은이들아 돌아라, 돌아라. 일곱 개의 깨짐 표기가 원문을 가로막아 나머지 내용은 신뢰성 있게 읽을 수 없어.", "B1", 48, "entertainment_music", "song_lyric", "song_lyric", "command", "colloquial", "high", "source_corruption"),
    ...
    127: item("tali fina che5, machi lbare7 bdina.", "The phrase 'tali fina che5' is unclear; it then says, 'We did not start yesterday.'", "'tali fina che5'라는 첫 구절은 뜻이 분명하지 않고, 이어서 '우리는 어제 시작한 게 아니야'라고 말해.", "B2", 55, "culture_tradition", "community_identity", "proverb", "opinion", "colloquial", "high", "source_ambiguity"),
