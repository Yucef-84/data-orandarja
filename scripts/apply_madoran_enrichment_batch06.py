"""Apply MADOran Batch 06 with source-only provenance and isolation gates."""
...
from scripts.build_madoran_enrichment_batch06 import (
    BATCH_FIELDS,
    BATCH_ID,
    BATCH_OUT,
    BASE_COMMIT,
...
def apply() -> dict[str, object]:
    ...
    for evidence in ("data/master/qa/madoran_enrichment_batch06_generation_qa.json", "data/master/qa/madoran_enrichment_batch06_qa.json"):
