"""Apply MADOran Batch 21 using the established source-only application gates."""
...
engine.BATCH_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch21_qa.json"
engine.EXPECTED_EXISTING_EVENTS = 17812
