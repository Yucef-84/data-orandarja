"""Apply MADOran Batch 15 using the established source-only application gates."""
...
engine.BATCH_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch15_qa.json"
engine.EXPECTED_EXISTING_EVENTS = 12216
