"""Apply MADOran Batch 19 using the established source-only application gates."""
...
engine.BATCH_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch19_qa.json"
engine.EXPECTED_EXISTING_EVENTS = 15946
