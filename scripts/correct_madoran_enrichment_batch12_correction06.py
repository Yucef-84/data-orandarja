"""Apply the full-batch review corrections for MADOran Batch 12."""
...
BASE_COMMIT = "9c21699"
CORRECTION_ID = "MADORAN-ENRICH-012-CORRECTION-06"
PROMPT_VERSION = "madoran-source-enrichment-v12-correction-6"
...
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch12_correction06_qa.json"

CORRECTIONS = {
    705: {"processing_flags": "code_switching|source_ambiguity"},
    730: {
        "english": "A related gendered and harsh proverb says that a woman who does not know how to prepare bouzlouf or douara and marries a respectable or decent man brings loss. The judgment about women and marriage is preserved as source content, not endorsed advice.",
        "korean": "이어지는 성별화된 거친 속담은 부즐루프나 두와라를 준비할 줄 모르는 여성이 좋은 집안의 아들이나 존중받는 남성과 결혼하면 손실을 가져온다는 식으로 말해요. 여성과 결혼에 관한 판단은 원문 내용으로 보존할 뿐 조언으로 지지하지 않아요.",
    },
    734: {
        "english": "The third category appears in groups of three, controlling a corner and playing cards or dominoes; they do not care about the world or worldly affairs, while girls in the same setting tell tragic stories about their lives.",
        "korean": "세 번째 유형은 세 명씩 모여 한쪽을 차지하고 카드나 도미노를 해요. 이들은 세상일이나 세속적인 일에는 아랑곳하지 않고, 같은 공간의 여자들은 자기 삶의 비극적인 이야기를 해요.",
    },
    748: {
        "english": "When they get engaged, she asks him the same question. He tells her, ‘What do you want?’ They say that once they are engaged they will decide; when they get married, he says he will hold her hand as she wishes.",
        "korean": "그들이 약혼하면 그녀가 그에게 같은 질문을 해요. 그는 그녀에게 ‘무엇을 원해?’라고 말해요. 약혼하면 그들이 결정을 내릴 것이라고 하고, 결혼하면 그가 그녀가 원하는 대로 손을 잡아 주겠다고 말해요.",
        "topic": "engagement_to_marriage_hand_holding",
    },
    752: {
        "english": "After twenty-five years of marriage, he says to her again, ‘What do you want—a man for your daughter?’ They say of the two of them that they have grown old and senile. The phrase 25 عام تع زواج refers to twenty-five years of marriage, not marriage age.",
        "korean": "결혼 25년 후에 그가 그녀에게 다시 ‘무엇을 원해? 딸에게 남자를 원해?’라고 말해요. 사람들은 두 사람이 나이가 들고 노망이 들었다고 말해요. ‘25 عام تع زواج’는 결혼 나이가 아니라 결혼생활 25년을 뜻해요.",
        "topic": "twenty_five_years_of_marriage_and_aging_joke",
    },
    755: {"processing_flags": "code_switching|source_ambiguity"},
    759: {
        "english": "After that, he takes only the woman his mother selected for him, as usual. The line also talks about manhood and asks God to bring a respectable or lawful boy. The exact social and romantic targets remain unclear.",
        "korean": "그 뒤 그는 평소처럼 그의 어머니가 그를 위해 골라 둔 여자만 택해요. 이어 남자다움에 대해 말하고 하느님이 올바르거나 존경할 만한 남자를 보내 주시기를 바라요. 정확한 사회적·연애 대상은 불분명해요.",
    },
    764: {"processing_flags": "code_switching|idiom_culture|source_ambiguity"},
    768: {
        "english": "People who came from far away were housed, while Oran’s children lived in iron shacks. The line exclaims about Oran, mentions a visitor taking a picture with a lion, and says that anyone who visits you is struck by your beauty. You welcome guests in winter and summer; several images remain culturally or contextually dense.",
        "korean": "먼 곳에서 온 사람들은 거처를 얻었지만 오랑의 아이들은 철제 판잣집에 살았다고 해요. 오랑을 외치며 방문객이 사자와 사진을 찍는 장면이 나오고, 당신을 찾아오는 사람은 당신의 아름다움에 놀란다고 해요. 겨울에도 여름에도 손님을 환영한다는 말이 이어지며, 몇몇 이미지는 문화적·문맥적으로 조밀하게 남아 있어요.",
    },
}
...
def apply():
    ...
    if not existing.endswith("\n") or existing_check["result"] != "PASS" or existing_check["events"] != 10398:
    ...
    if combined_check["result"] != "PASS" or combined_check["events"] != 10415 or trace["result"] != "PASS":
    ...
    evidence_path = "data/master/qa/madoran_enrichment_batch12_correction06_qa.json"
    ...
    qa.update({
        ...
        "total_provenance_events": 10415,
        "expected_total_provenance_events": 10415,
    ...
    correction_qa = {
        ...
        "provenance_events_before": 10398,
        "provenance_events_after": 10415,
        "source_gate": "PASS",
