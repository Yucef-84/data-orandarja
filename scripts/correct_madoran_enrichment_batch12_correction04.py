"""Apply the final speaker-attribution correction for MADOran Batch 12."""
...
BASE_COMMIT = "5896bf5"
CORRECTION_ID = "MADORAN-ENRICH-012-CORRECTION-04"
PROMPT_VERSION = "madoran-source-enrichment-v12-correction-4"
...
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch12_correction04_qa.json"

CORRECTIONS = {
    749: {
        "english": "When they get married, she asks him again. He tells her: ‘You know, we have a home and are مستورين/مستروين—thank God; do whatever you want in it.’ The term is a state expression meaning that they are settled, provided for, or living respectably, not a separate object or piece of furniture.",
        "korean": "그들이 결혼하면 그녀가 그에게 다시 물어요. 그러자 그는 그녀에게 ‘알다시피 우리에게 집이 있고 형편도 갖춰져 있어. 하느님께 감사하니 그 안에서 네가 원하는 일을 해’라고 말해요. ‘مستورين/مستروين’은 별도의 물건이나 가구가 아니라 형편이 갖춰지고 안정되며 남부럽지 않게 지낸다는 상태 표현이에요.",
    },
}
...
def apply():
    ...
    if not existing.endswith("\n") or existing_check["result"] != "PASS" or existing_check["events"] != 10392:
    ...
    if combined_check["result"] != "PASS" or combined_check["events"] != 10394 or trace["result"] != "PASS":
    ...
    evidence_path = "data/master/qa/madoran_enrichment_batch12_correction04_qa.json"
    ...
    qa.update({
        ...
        "total_provenance_events": 10394,
        "expected_total_provenance_events": 10394,
    ...
    correction_qa = {
        ...
        "provenance_events_before": 10392,
        "provenance_events_after": 10394,
        "source_gate": "PASS",
