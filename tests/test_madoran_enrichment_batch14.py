...
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch14_correction08_qa.json"
...
class MadoranEnrichmentBatch14Tests(unittest.TestCase):
    ...
    def test_batch14_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 904)
        self.assertEqual(application["total_provenance_events"], 12216)
        ...
        self.assertEqual(correction["provenance_events_after"], 12216)
