...
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch14_correction07_qa.json"
...
class MadoranEnrichmentBatch14Tests(unittest.TestCase):
    ...
    def test_batch14_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 12212)
    ...
    def test_batch14_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 900)
        self.assertEqual(application["total_provenance_events"], 12212)
        self.assertEqual(application["expected_total_provenance_events"], 12212)
        ...
        self.assertEqual(correction["provenance_events_after"], 12212)
