...
class MadoranEnrichmentBatch14Tests(unittest.TestCase):
    ...
    def test_batch14_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 12127)
    ...
    def test_batch14_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["total_provenance_events"], 12127)
        self.assertEqual(application["expected_total_provenance_events"], 12127)
        ...
        self.assertEqual(correction["changed_fields"], 31)
        self.assertEqual(correction["provenance_events_after"], 12127)
