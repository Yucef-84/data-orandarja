...
from scripts.build_madoran_enrichment_batch14 import (
...
GENERATION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch14_generation_qa.json"
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch14_correction04_qa.json"
...
class MadoranEnrichmentBatch14Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_batch14_header_and_range(self):
    ...
    def test_batch14_source_only_validation_passes(self):
    ...
    def test_batch14_manifest_contract(self):
    ...
    def test_batch14_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 12178)
    ...
    def test_batch14_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["provenance_events_before"], 11312)
        self.assertEqual(application["new_provenance_events"], 866)
        self.assertEqual(application["total_provenance_events"], 12178)
        self.assertEqual(application["expected_total_provenance_events"], 12178)
        ...
        self.assertEqual(correction["changed_fields"], 23)
        self.assertEqual(correction["provenance_events_after"], 12178)

    def test_full_validator_passes_after_batch14_application(self):
