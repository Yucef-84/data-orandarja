...
class MadoranEnrichmentBatch09Tests(unittest.TestCase):
    ...
    def test_batch09_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 759)
        self.assertEqual(application["total_provenance_events"], 7762)
        self.assertEqual(application["expected_total_provenance_events"], 7762)
    ...
    def test_batch09_representative_values_preserve_source_details(self):
        ...
        self.assertIn("two pieces", rows[543]["english"])
