...
class MadoranEnrichmentBatch09Tests(unittest.TestCase):
    ...
    def test_batch09_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 803)
        self.assertEqual(application["total_provenance_events"], 7806)
        self.assertEqual(application["expected_total_provenance_events"], 7806)
