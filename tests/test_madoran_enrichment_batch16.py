...
CORRECTION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch16_correction03_qa.json"
...
class MadoranEnrichmentBatch16Tests(unittest.TestCase):
    ...
    def test_batch16_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 13928)
    ...
    def test_batch16_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 865)
        self.assertEqual(application["total_provenance_events"], 13928)
        self.assertEqual(application["expected_total_provenance_events"], 13928)
        ...
        self.assertEqual(correction["changed_fields"], 11)
        self.assertEqual(correction["provenance_events_before"], 13917)
        self.assertEqual(correction["provenance_events_after"], 13928)
