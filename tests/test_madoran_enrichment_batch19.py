...
from scripts.build_madoran_enrichment_batch19 import (
...
CORRECTION03_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch19_correction03_qa.json"
...
class MadoranEnrichmentBatch19Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_batch19_header_and_range(self):
    ...
    def test_batch19_source_only_validation_passes(self):
    ...
    def test_batch19_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 16851)
    ...
    def test_batch19_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(generation["draft_rows"], 5)
        self.assertEqual(generation["flagged_rows"], 59)
        self.assertEqual(generation["processing_flags_populated_rows"], 59)
        ...
        self.assertEqual(application["new_provenance_events"], 905)
        self.assertEqual(application["total_provenance_events"], 16851)
        self.assertEqual(application["expected_total_provenance_events"], 16851)
        ...
        self.assertEqual(application["review_id"], "MADORAN-ENRICH-019-REVIEW-01")
        self.assertEqual(application["reviewed_commit"], "03dda2fd569f766ac152d79f0e2045d793da8266")
        ...
        self.assertEqual(correction["changed_fields"], 113)
        self.assertEqual(correction["state_updates"], 15)
        ...
        self.assertEqual(correction03["changed_fields"], 2)
        self.assertEqual(correction03["provenance_events_after"], 16851)
        self.assertEqual(correction03["draft_rows"], 20)
        self.assertEqual(correction03["flagged_rows"], 44)
