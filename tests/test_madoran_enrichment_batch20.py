...
class MadoranEnrichmentBatch20Tests(unittest.TestCase):
    ...
    def test_batch20_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 17806)
    ...
    def test_batch20_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 955)
        self.assertEqual(application["total_provenance_events"], 17806)
        self.assertEqual(application["expected_total_provenance_events"], 17806)
