...
from scripts.build_madoran_enrichment_batch13 import (
...
GENERATION_QA_OUT = ROOT / "data/master/qa/madoran_enrichment_batch13_generation_qa.json"
...
class MadoranEnrichmentBatch13Tests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_batch13_header_and_range(self):
    ...
    def test_batch13_source_only_validation_passes(self):
    ...
    def test_batch13_provenance_and_latest_hash_gate_pass(self):
    ...
    def test_batch13_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["total_provenance_events"], 11312)
        self.assertEqual(application["expected_total_provenance_events"], 11312)
