...
class MadoranEnrichmentBatch18Tests(unittest.TestCase):
    ...
    def test_batch18_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 15930)
    ...
    def test_batch18_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 957)
        self.assertEqual(application["total_provenance_events"], 15930)
        self.assertEqual(application["expected_total_provenance_events"], 15930)
