...
class MadoranEnrichmentBatch18Tests(unittest.TestCase):
    ...
    def test_batch18_headgpt_correction_artifact_and_key_fixes(self):
        ...
        correction05 = json.loads((ROOT / "data/master/qa/madoran_enrichment_batch18_correction05_qa.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(correction05["batch_artifact_sync_state_updates"], 0)
    ...
    def test_batch18_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 973)
        self.assertEqual(application["total_provenance_events"], 15946)
