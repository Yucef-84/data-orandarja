...
class MadoranEnrichmentBatch18Tests(unittest.TestCase):
    ...
    def test_batch18_provenance_and_latest_hash_gate_pass(self):
        ...
        self.assertEqual(event_check["events"], 15940)
    ...
    def test_batch18_headgpt_correction_artifact_and_key_fixes(self):
        ...
        self.assertIn("If you do not move", rows["1146"]["english"])
    ...
    def test_batch18_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 967)
        self.assertEqual(application["total_provenance_events"], 15940)
        self.assertEqual(application["expected_total_provenance_events"], 15940)
