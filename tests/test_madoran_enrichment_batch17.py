...
class MadoranEnrichmentBatch17Tests(unittest.TestCase):
    ...
    def test_batch17_source_only_validation_passes(self):
        ...
        self.assertEqual(report["processing_flags_populated_rows"], 64)
    ...
    def test_batch17_state_distribution_and_ascii(self):
        ...
        self.assertEqual(sum(bool(row["processing_flags"]) for row in target), 64)
    ...
    def test_batch17_generation_and_application_qa_pass(self):
        ...
        self.assertEqual(application["new_provenance_events"], 768)
        self.assertEqual(application["total_provenance_events"], 14711)
        self.assertEqual(application["expected_total_provenance_events"], 14711)
        self.assertEqual(application["processing_flags_populated_rows"], 897)
        self.assertEqual(application["batch_processing_flags_populated_rows"], 64)
